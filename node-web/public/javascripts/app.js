	...
	(function (root, factory) {
	    ...
	    defineProperties(Date.prototype, {
	        toISOString: function toISOString() {
	            ...
	            return year + '-' + arraySlice(result, 0, 2).join('-') + 'T' + arraySlice(result, 2).join(':') + '.' + strSlice('000' + this.getUTCMilliseconds(), -3) + 'Z';
	        }
	        ...
	        Date = (function (NativeDate) {
	            ...
	            var DateShim = function Date(Y, M, D, h, m, s, ms) {
	                ...
	                if (this instanceof NativeDate) {
	                    ...
	                    // length here
	                    length >= 7 ? new NativeDate(Y, M, D, h, m, seconds, millis) : length >= 6 ? new NativeDate(Y, M, D, h, m, seconds) : length >= 5 ? new NativeDate(Y, M, D, h, m) : length >= 4 ? new NativeDate(Y, M, D, h) : length >= 3 ? new NativeDate(Y, M, D) : length >= 2 ? new NativeDate(Y, M) : length >= 1 ? new NativeDate(Y) : new NativeDate();
	                } else {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var newElement = _require.newElement;
	var addEventListener = _require.addEventListener;

	var _require2 = __webpack_require__(6);

	var ConsoleRender = _require2.ConsoleRender;
	var DomRender = _require2.DomRender;
	...
	*/
	...
	Calendar.prototype = {
	    ...
	    createCalendarBody: function createCalendarBody(self, arr) {
	    ...
	    createCalendarHeader: function createCalendarHeader(calendar) {
	        var calendar = this;
	    ...
	    createCalendarFooter: function createCalendarFooter() {
	        var calendar = this;
	    ...
	    destroy: function destroy() {
	        //distory calendar table element and recreate one.
	        if (process.browser) {
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	var newElement = __webpack_require__(5).newElement;
